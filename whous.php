...
<head>
  ...
  <title>عقاري | من نحن</title>
  <!-- نفس ملف الـ CSS اللي تستخدمه بالموقع -->
 <style>:root{
  --bg: #f8fafd;
  --panel: #ffffff;
  --panel-2: #f0f4f8;
...
<?php endif; ?>
      ...
      <a class="active" href="whous.php">من نحن</a>
     <?php if (isset($_SESSION['user_id'])): ?>
...
<?php endif; ?>
  ...
  <section class="hero">
    <div class="hero-overlay">
       <h1>عقاري</h1>
      <h1>من نحن</h1>
      <p>منصّة عقارية موثوقة توفر لك الحل الأسرع للعثور على عقارك المناسب</p>
    </div>
  </section>

  <main class="grid about">

    <article class="card" style="grid-column: span 3; padding: 24px;">
      <h2 style="margin-bottom: 16px;">نبذة عن منصّة عقاري</h2>
      <p style="line-height: 1.9; font-size: 18px; color: var(--muted);">
        عقاري هي منصّة فلسطينية متخصصة في عرض العقارات السكنية والتجارية
        والأراضي في مختلف المدن والمناطق. نسعى لتقديم تجربة بحث سهلة وسريعة
        تُمكّن المستخدم من الوصول إلى أفضل الخيارات المتاحة دون عناء. نركز على
        الشفافية، الدقة، وسهولة الاستخدام، ونقدم معلومات موثوقة وصورًا عالية الجودة
        لمساعدتك في اتخاذ قرارك بثقة.
        <br><br>
        رؤيتنا هي أن نكون المنصة العقارية الأولى في فلسطين، وأن نجمع بين التكنولوجيا
        الحديثة وخبرة السوق لنقدم خدمة موثوقة وآمنة لكل من يرغب بالبيع، الشراء أو الإيجار.
        في عقاري، نعتبر كل عميل شريكًا في النجاح، ونعمل على توفير أفضل تجربة ممكنة له.
      </p>
    </article>
